...
let contactTemplate = (data, onDetails) => html`<div class="contact card">
    <div>
...
function start() {
    let conteiner = document.getElementById("contacts");
    ...
    function onRender() {
        render(contacts.map(c => contactTemplate(c, onDetails)), conteiner)
    }
