        ...
        if (this._comments.length > 0) {
            ...
            if (sortingType === "asc") {
                ...
                for (let comment of this._comments.sort((a, b) => a.Id - b.Id)) {
                    ...
                    for (let replay of comment.Replies.sort((a, b) => a.Id - b.Id)) {
                        output += `\n--- ${comment.Id}.${replay.Id}. ${replay.Username}: ${replay.Content}`
                    }
                ...
                for (let comment of this._comments.sort((a, b) => b.Id - a.Id)) {
                    ...
                    for (let replay of comment.Replies.sort((a, b) => b.Id - a.Id)) {
                        output += `\n--- ${comment.Id}.${replay.Id}. ${replay.Username}: ${replay.Content}`
                    }
                }
                ...
                for (let comment of this._comments.sort((a, b) => a.Username.localeCompare(b.Username))) {
                    ...
                    for (let replay of comment.Replies.sort((a, b) => a.Username.localeCompare(b.Username))) {
                        output += `\n--- ${comment.Id}.${replay.Id}. ${replay.Username}: ${replay.Content}`
                    }
                }
            }
