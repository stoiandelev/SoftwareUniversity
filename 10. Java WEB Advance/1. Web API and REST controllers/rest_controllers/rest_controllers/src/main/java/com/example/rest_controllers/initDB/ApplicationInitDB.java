package com.example.rest_controllers.initDB;
...
public class ApplicationInitDB implements CommandLineRunner {
    ...
    public ApplicationInitDB(AuthorRepository authorRepository, BookRepository bookRepository) {
