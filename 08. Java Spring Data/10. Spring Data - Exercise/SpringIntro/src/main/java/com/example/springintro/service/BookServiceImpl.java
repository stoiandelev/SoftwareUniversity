...
import com.example.springintro.service.implementation.BookService;
...
public class BookServiceImpl implements BookService {
    ...
    private Book createBookFromInfo(String[] bookInfo) {
        ...
        LocalDate releaseData = LocalDate.parse(bookInfo[1], DateTimeFormatter.ofPattern("d/M/yyyy"));
        ...
        return new Book(editionType, releaseData, copies, price,
