...
let detailsTemplate = (itemPromise) => html`
...
let itemTemplate = (item, isOwner, onDelete) => html`
<div class="col-md-4">
...
export function detailsPage(ctx) {
    ...
    async function onDelete() {
        let choice = await showModal("Are you sure you want to delete this item?");        
...
async function loadItem(id, onDelete) {
    ...
    let isOwner = userData.id == item._ownerId;
